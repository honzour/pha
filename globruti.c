...
char NazvyVysledku[8][38]={
 ...
 "Remíza díky pravidlu padesáti tahů",
 "Remíza, bílý dostal pat",
 "Remíza, černý dostal pat",
...
{s16 i;
 ...
 for(i=uloha->zasobnik.hranice[uloha->zasobnik.pos];
  ...
  if(tah==uloha->zasobnik.tahy[i].data) {uloha->zasobnik.pos--;return 1;}
...
/*************************************************************************/
/*  KTNehledej -  Analogie KorektiTah, jen u ve musí být na zásobníku. */
...
/*********************************************/
/* Pozice je před zahráním tahu t.           */
/* vrací 1 - je to tah pěcem nebo braní  */
/* 0 - jindy                             */
/*********************************************/
